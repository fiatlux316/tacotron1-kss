...
This prepares KSS-Dataset (available at https://kaggle.com/bryanpark/korean-single-speaker-speech-dataset/) to json and wav format
...
dataset_dir = "/home3/workspace/reference/datasets/kss"
...
def read_csv(path,fn_encoding='UTF8'):
    ...
    with open(path, encoding=fn_encoding) as f:
        ...
        for line in f:
            audio_name, audio_transcript,audio_normalized_transcript,_,_ = line.split('|')
